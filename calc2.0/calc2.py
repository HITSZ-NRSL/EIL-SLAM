...
if __name__ == '__main__':
    ...
    tf.app.flags.DEFINE_integer("batch_size", 4, "Size of mini-batch.")
    ...
    tf.app.flags.DEFINE_string("input_dir", "/home/jason/calc2.0/dataset/coco/calc_tfrecords/", "tfrecords dir")
