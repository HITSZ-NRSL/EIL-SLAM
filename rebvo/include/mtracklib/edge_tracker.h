...
public:
    ...
    int directed_matching_depth(pcl::PointCloud<pcl::PointXYZI>::Ptr depthCloud, pcl::KdTreeFLANN<pcl::PointXYZI>::Ptr kdTree);
    ...
    // int search_match_depth(cv::Mat* depthMap);
    int search_match_depth(KeyLine &k,cam_model &cam0,pcl::PointCloud<pcl::PointXYZI>::Ptr depthCloud,pcl::KdTreeFLANN<pcl::PointXYZI>::Ptr kdTree);
